...
import { Users, Copy, Check, Play, Settings, Hash, UserPlus } from 'lucide-react';
...
export function RoomWaiting({ room, currentPlayerId, isHost, onStartGame, onLeaveRoom }: RoomWaitingProps) {
